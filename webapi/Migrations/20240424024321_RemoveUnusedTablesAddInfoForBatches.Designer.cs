...
namespace webapi.Migrations
{
    ...
    [Migration("20240424024321_RemoveUnusedTablesAddInfoForBatches")]
    partial class RemoveUnusedTablesAddInfoForBatches
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChangelogBatchContact", b =>
                {
                    b.Property<int>("ChangelogBatchesId")
                        .HasColumnType("int");

                    b.Property<int>("ContactsContactId")
                        .HasColumnType("int");

                    b.HasKey("ChangelogBatchesId", "ContactsContactId");

                    b.HasIndex("ContactsContactId");

                    b.ToTable("ChangelogBatchContact");
                });
            ...
            modelBuilder.Entity("webapi.Models.AggregatedDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webapi.Models.ReceiptItem", b =>
                {
            ...
            modelBuilder.Entity("webapi.Models.UserSettings", b =>
                {
                    ...
                    b.Property<string>("AddInventoryDefaultGrade")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("B-FRN");
                    ...
                    b.Property<string>("RemoveInventoryDefaultGrade")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("B-FRN");
                    ...
                    b.Property<bool>("TableFullScreenByDefault")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("ChangelogBatchContact", b =>
                {
                    b.HasOne("webapi.Models.ChangelogBatch", null)
                        .WithMany()
                        .HasForeignKey("ChangelogBatchesId")
            ...
            modelBuilder.Entity("webapi.Models.DeviceType", b =>
                {
                    b.Navigation("AggregatedDevices");
